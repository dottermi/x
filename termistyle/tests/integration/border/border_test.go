...
func TestGolden_Border_Styles(t *testing.T) {
	...
	// Single
	draw.DrawBorder(buf, 0, 0, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorBlue))
	draw.DrawText(buf, 2, 2, "Single", ColorMuted, ColorBg)

	// Double
	draw.DrawBorder(buf, 25, 0, 20, 5, style.BorderAllWithColor(style.BorderDouble, ColorBlue))
	draw.DrawText(buf, 27, 2, "Double", ColorMuted, ColorBg)

	// Round
	draw.DrawBorder(buf, 0, 7, 20, 5, style.BorderAllWithColor(style.BorderRound, ColorBlue))
	draw.DrawText(buf, 2, 9, "Round", ColorMuted, ColorBg)

	// Bold
	draw.DrawBorder(buf, 25, 7, 20, 5, style.BorderAllWithColor(style.BorderBold, ColorBlue))
...
func TestGolden_Border_Colors(t *testing.T) {
	...
	// Green border
	draw.DrawBorder(buf, 25, 0, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorGreen))
	draw.DrawText(buf, 27, 2, "Green", ColorGreen, ColorBg)

	// Orange border
	draw.DrawBorder(buf, 0, 7, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorOrange))
	draw.DrawText(buf, 2, 9, "Orange", ColorOrange, ColorBg)

	// Red border
	draw.DrawBorder(buf, 25, 7, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorRed))
	draw.DrawText(buf, 27, 9, "Red", ColorRed, ColorBg)
...
func TestGolden_Border_Titles(t *testing.T) {
	...
	// Top: Title left
	draw.DrawBorder(buf, 0, 0, 45, 5, style.BorderAllWithTitle(style.BorderSingle, ColorCyan, "Top Left"))

	// Top: Title center
	border := style.BorderAllWithColor(style.BorderSingle, ColorCyan)
	border.Top = border.Top.AddText("Top Center", style.TextAlignCenter)
	draw.DrawBorder(buf, 0, 6, 45, 5, border)

	// Top: Title right
	border2 := style.BorderAllWithColor(style.BorderSingle, ColorCyan)
	border2.Top = border2.Top.AddText("Top Right", style.TextAlignRight)
	draw.DrawBorder(buf, 0, 12, 45, 5, border2)

	// Bottom: Title left
	border3 := style.BorderAllWithColor(style.BorderSingle, ColorCyan)
	...
	border4 := style.BorderAllWithColor(style.BorderSingle, ColorCyan)
...
func TestGolden_Border_Partial(t *testing.T) {
	...
	// Top only
	border1 := style.Border{Top: style.BorderEdge{Style: style.BorderSingle, Color: ColorBlue}}
	...
	border2 := style.Border{
		...
		Right: style.BorderEdge{Style: style.BorderSingle, Color: ColorBlue},
	}
	...
	// Bottom only
	border5 := style.Border{Bottom: style.BorderEdge{Style: style.BorderSingle, Color: ColorBlue}}
...
func TestGolden_Border_Complete(t *testing.T) {
	...
	// Box 1: User Profile - Round cyan border
	border1 := style.BorderAllWithColor(style.BorderRound, ColorCyan)
	...
	// Box 2: Menu - Double pink border
	border2 := style.BorderAllWithColor(style.BorderDouble, ColorPink)
	...
	// Box 3: Warning - Bold red border
	border3 := style.BorderAllWithColor(style.BorderBold, ColorRed)
	...
	draw.DrawStyledText(buf, 2, 14, "CPU: 95%", style.Style{Foreground: ColorRed})
	draw.DrawStyledText(buf, 15, 14, "RAM: 87%", style.Style{Foreground: ColorOrange})
	draw.DrawStyledText(buf, 28, 14, "Disk: 45%", style.Style{Foreground: ColorGreen})

	// Box 4: Note - Partial green border (no right)
	border4 := style.Border{
		Top:    style.BorderEdge{Style: style.BorderSingle, Color: ColorGreen},
		Bottom: style.BorderEdge{Style: style.BorderSingle, Color: ColorGreen},
		Left:   style.BorderEdge{Style: style.BorderSingle, Color: ColorGreen},
	}
	...
	// Box 5: Stats - Round blue border
	border5 := style.BorderAllWithColor(style.BorderRound, ColorBlue)
