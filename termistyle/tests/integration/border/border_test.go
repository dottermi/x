...
func TestGolden_Border_Styles(t *testing.T) {
	...
	// Single
	draw.Border(buf, 0, 0, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorBorder))
	draw.Text(buf, 2, 2, "Single", ColorMuted, ColorBg)

	// Double
	draw.Border(buf, 25, 0, 20, 5, style.BorderAllWithColor(style.BorderDouble, ColorBorder))
	draw.Text(buf, 27, 2, "Double", ColorMuted, ColorBg)

	// Round
	draw.Border(buf, 0, 7, 20, 5, style.BorderAllWithColor(style.BorderRound, ColorBorder))
	draw.Text(buf, 2, 9, "Round", ColorMuted, ColorBg)

	// Bold
	draw.Border(buf, 25, 7, 20, 5, style.BorderAllWithColor(style.BorderBold, ColorBorder))
	draw.Text(buf, 27, 9, "Bold", ColorMuted, ColorBg)
...
func TestGolden_Border_Colors(t *testing.T) {
	...
	// Cyan border
	draw.Border(buf, 0, 0, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorCyan))
	draw.Text(buf, 2, 2, "Cyan", ColorCyan, ColorBg)

	// Cyan2 border
	draw.Border(buf, 25, 0, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorCyan2))
	draw.Text(buf, 27, 2, "Cyan2", ColorCyan2, ColorBg)

	// Blue border
	draw.Border(buf, 0, 7, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorBlue))
	draw.Text(buf, 2, 9, "Blue", ColorBlue, ColorBg)

	// Blue2 border
	draw.Border(buf, 25, 7, 20, 5, style.BorderAllWithColor(style.BorderSingle, ColorBlue2))
	draw.Text(buf, 27, 9, "Blue2", ColorBlue2, ColorBg)
...
func TestGolden_Border_Titles(t *testing.T) {
	...
	// Top: Title left
	draw.Border(buf, 0, 0, 45, 5, style.BorderAllWithTitle(style.BorderSingle, ColorAccent, "Top Left"))
	...
	draw.Border(buf, 0, 6, 45, 5, border)
	...
	draw.Border(buf, 0, 12, 45, 5, border2)
	...
	draw.Border(buf, 0, 18, 45, 5, border3)
	...
	draw.Border(buf, 0, 24, 45, 4, border4)
...
func TestGolden_Border_Partial(t *testing.T) {
	...
	draw.Border(buf, 0, 0, 20, 5, border1)
	draw.Text(buf, 2, 2, "Top only", ColorMuted, ColorBg)
	...
	draw.Border(buf, 25, 0, 20, 5, border2)
	draw.Text(buf, 27, 2, "Left+Right", ColorMuted, ColorBg)
	...
	draw.Border(buf, 0, 7, 20, 5, border3)
	draw.Text(buf, 2, 9, "Top+Bottom", ColorMuted, ColorBg)
	...
	draw.Border(buf, 25, 7, 20, 5, border4)
	draw.Text(buf, 27, 9, "No bottom", ColorMuted, ColorBg)

	// Bottom only
	border5 := style.Border{Bottom: style.BorderEdge{Style: style.BorderSingle, Color: ColorBorder}}
	draw.Border(buf, 0, 14, 20, 5, border5)
	draw.Text(buf, 2, 16, "Bottom only", ColorMuted, ColorBg)
	...
	draw.Border(buf, 25, 14, 20, 5, border6)
	draw.Text(buf, 27, 16, "Top+Left", ColorMuted, ColorBg)
...
func TestGolden_Border_Complete(t *testing.T) {
	...
	draw.Border(buf, 0, 0, 28, 8, border1)
	draw.StyledText(buf, 2, 2, "Name: John Doe", style.Style{
		Foreground: ColorText,
		FontWeight: style.WeightBold,
	})
	draw.StyledText(buf, 2, 3, "Email: john@example.com", style.Style{
		Foreground: ColorMuted,
	})
	draw.StyledText(buf, 2, 5, "Premium Member", style.Style{
	...
	draw.Border(buf, 30, 0, 28, 8, border2)
	draw.Text(buf, 32, 2, "1. Dashboard", ColorText, ColorBg)
	draw.Text(buf, 32, 3, "2. Settings", ColorText, ColorBg)
	draw.Text(buf, 32, 4, "3. Help", ColorText, ColorBg)
	draw.StyledText(buf, 32, 6, "Select option...", style.Style{
		Foreground: ColorMuted,
		FontStyle:  style.StyleItalic,
	})
	...
	draw.Border(buf, 0, 10, 58, 7, border3)
	draw.StyledText(buf, 2, 12, "INFO:", style.Style{
		Foreground: ColorCyan,
		FontWeight: style.WeightBold,
	})
	draw.StyledText(buf, 9, 12, "System status check complete", style.Style{
		Foreground: ColorText,
	})
	draw.StyledText(buf, 2, 14, "CPU: 45%", style.Style{Foreground: ColorCyan2})
	draw.StyledText(buf, 15, 14, "RAM: 67%", style.Style{Foreground: ColorCyan})
	draw.StyledText(buf, 28, 14, "Disk: 32%", style.Style{Foreground: ColorAccent})
	...
	draw.Border(buf, 0, 19, 28, 9, border4)
	draw.StyledTextInBox(buf, 2, 21, "This is a longer text that should wrap nicely within the box boundaries.", 24, 5, style.Style{
		Foreground: ColorMuted,
	...
	draw.Border(buf, 30, 19, 28, 9, border5)
	draw.StyledText(buf, 32, 21, "Downloads", style.Style{
		Foreground:    ColorText,
		TextTransform: style.TransformUppercase,
	})
	draw.StyledText(buf, 45, 21, "1,234", style.Style{
		Foreground: ColorCyan2,
		FontWeight: style.WeightBold,
	})
	draw.StyledText(buf, 32, 23, "Uploads", style.Style{
		Foreground:    ColorText,
		TextTransform: style.TransformUppercase,
	})
	draw.StyledText(buf, 45, 23, "567", style.Style{
		Foreground: ColorCyan2,
		FontWeight: style.WeightBold,
	})
	draw.StyledText(buf, 32, 25, "Errors", style.Style{
		Foreground:    ColorText,
		TextTransform: style.TransformUppercase,
	})
	draw.StyledText(buf, 45, 25, "3", style.Style{
		Foreground: ColorCyan,
		FontWeight: style.WeightBold,
	})
